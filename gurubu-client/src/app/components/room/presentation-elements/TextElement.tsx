...
const TextElement = ({ element, isEditing = false, isSelected = false, onSelect, onUpdate, onContextMenu, zIndex }: TextElementProps) => {
  ...
  const handleDoubleClick = (e: React.MouseEvent) => {
    ...
    // Focus after a short delay to ensure element is selected
    setTimeout(() => {
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: isEditing ? (isDragging ? 'grabbing' : 'move') : 'text',
